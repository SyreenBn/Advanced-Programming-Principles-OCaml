...
#### Total score: _63_ / _73_

Run on March 18, 20:54:50 PM.
...
+  _0_ / _1_ : Fail: Check that the result of evaluating `btf_to_list Empty` matches the pattern `[ ]`.
...
+  _0_ / _1_ : Fail: Check that the result of evaluating `btf_to_list (Node (Empty, 3, Empty))` matches the pattern `[3]`.
...
+  _0_ / _1_ : Fail: Check that the result of evaluating `btf_elem_by (=) 5 Empty` matches the pattern `false`.
